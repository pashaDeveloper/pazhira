const fa: { [key: string]: string } = {
  ...
  zishopMap: "نقشه Pazhira",
  aboutUs: "دربارۀ ما",
  contactUs: "تماس با ما",
  saleInPazhira: "فروش در Pazhira",
  ...
  enterVerificationCode: "کد ۴ رقمی ارسال شده به تلفن خود را وارد کنید",
  ...
  Invalid_verification_code: "کد تایید اشتباه است",
  ...
  repair: "تعمیرات",
  priceCheck: "قیمت گذاری",
  orderNumber: "شماره سفارش",
  enterOrderNumber: "شماره سفارش خود را وارد کنید",
  track: "پیگیری",
  ...
  shipped: "ارسال شده",
  outForDelivery: "در مسیر تحویل",
  delivered: "تحویل داده شده",
  repairRequest: "درخواست تعمیر",
  ...
  enterDeviceModel: "مدل دستگاه خود را وارد کنید",
  issueDescription: "شرح مشکل",
  describeTheIssue: "مشکل دستگاه خود را شرح دهید",
  submitRepairRequest: "ثبت درخواست تعمیر",
  success: "موفقیت",
  repairRequestSubmitted: "درخواست تعمیر شما با موفقیت ثبت شد",
  devicePriceCheck: "برآورد قیمت دستگاه",
  deviceBrand: "برند دستگاه",
  enterDeviceBrand: "برند دستگاه خود را وارد کنید",
  deviceCondition: "وضعیت دستگاه",
  excellent: "عالی",
  good: "خوب",
  fair: "معمولی",
  includedAccessories: "لوازم جانبی موجود",
  charger: "شارژر",
  earphones: "هدفون",
  case: "کیف",
  originalBox: "جعبه اصلی",
  calculatePrice: "محاسبه قیمت",
  estimatedPrice: "قیمت تخمینی",
  currency: "تومان",
  priceEstimateNote: "این قیمت تخمینی است و قیمت نهایی ممکن است متفاوت باشد",
  repairContact: "تماس برای تعمیرات",
  engineerX: "مهندس X",
  deviceType: "نوع دستگاه",
  issueType: "نوع خرابی",
  softwareIssue: "نرم افزاری",
  hardwareIssue: "سخت افزاری",
  address: "آدرس",
  expectedRepairTime: "زمان مورد انتظار برای تعمیر",
