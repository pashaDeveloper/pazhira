const en: { [key: string]: string } = {
  ...
  zishopMap: "Pazhira Map",
  aboutUs: "About Us",
  contactUs: "Contact Us",
  saleInPazhira: "Sale In Pazhira",
  ...
  register: "Register",
  copyRight:
    "© 2022 Pazhira. All rights reserved - Designed and Developed with ",
  sort: "Sort based on: ",
  all: "All",
  ...
  enterVerificationCode: "Enter the 4-digit code sent to your phone",
  ...
  enterDeviceModel: "Enter your device model",
  issueDescription: "Issue Description",
  describeTheIssue: "Describe the issue with your device",
  submitRepairRequest: "Submit Repair Request",
  success: "Success",
  repairRequestSubmitted: "Your repair request has been submitted successfully",
  devicePriceCheck: "Device Price Check",
  deviceBrand: "Device Brand",
  enterDeviceBrand: "Enter your device brand",
  ...
  currency: "Toman",
  priceEstimateNote: "This is an estimated price and the final price may vary",
  repairContact: "Repair Contact",
  engineerX: "Engineer X",
  deviceType: "Device Type",
  issueType: "Issue Type",
  softwareIssue: "Software Issue",
  hardwareIssue: "Hardware Issue",
  address: "Address",
  expectedRepairTime: "Expected Repair Time",
